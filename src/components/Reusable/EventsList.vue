    ...
    <div>
         <v-parallax class="service" height="250">
          ...
          >
            ...
            <h1 class="white--text title_font text-xs-center">События</h1>
...
<v-progress-linear indeterminate v-if="loading"></v-progress-linear>
                    <h5 v-if="loading" class="text-xs-center secondary--text">Контент будет готов, пожалуйста, подождите ...</h5>
               
                </v-flex>
            </v-layout>
          <v-layout column wrap v-else>
              <v-flex xs12 sm6 md12>
                    <h2 class="mt-4 pt-1 pr-1 pl-2 title_popins">{{event.title}}</h2>
              </v-flex>
              <v-flex xs12 sm6 md12>
...
<v-card-text class="title_crilic" v-html="event.description"></v-card-text>
                  </v-card>
